...
-- groom_assignments 70.., training_locks f0..
--
-- Ngựa có tối đa 1 chủ (horses.owner_id) và thuộc 1 khu (horses.barn_id).
-- Phả hệ chỉ dùng ngựa có hồ sơ trong CLB, không có ngựa tham chiếu.
...
BEGIN
  ...
  -- ── Khu chuồng ──────────────────────────────────────────────
  -- Khu A, B, cách ly có head trainer; khu C chưa có (không xếp ngựa vào được).
  INSERT INTO barns (id, name, description, capacity, status, head_trainer_id, version) VALUES
    ...
    ('b0000000-0000-4000-8000-000000000002', 'Khu B (seed)', 'Khu phụ', 6, 'ACTIVE', head_trainer_id, 1),
    ('b0000000-0000-4000-8000-000000000003', 'Khu cách ly (seed)', 'Ô tách đàn ngựa nghi nhiễm bệnh', 3, 'ACTIVE', head_trainer_id, 1),
    ('b0000000-0000-4000-8000-000000000004', 'Khu C (seed)', 'Khu mới, chưa có head trainer', 4, 'ACTIVE', NULL, 1)
  ON CONFLICT (id) DO NOTHING;
  ...
  -- chờ xếp khu (Ngọc Lan), chờ xếp ô (Vô Danh), có training lock,
  -- hồ sơ thiếu thông tin, hồ sơ đã xóa. Kim Ô + Tuyết Sơn làm cha mẹ trong phả hệ.
  INSERT INTO horses (id, name, gender, breed, color, race_aptitude, date_of_birth, microchip_id, sire_id, dam_id, owner_id, barn_id, health_status, lifecycle_status, deleted_at, version) VALUES
    ('a0000000-0000-4000-8000-000000000008', 'Kim Ô', 'MALE', 'Arabian', 'Palomino', 'MILER', '2012-09-09', '900000000000008', NULL, NULL, NULL, 'b0000000-0000-4000-8000-000000000002', 'ELIGIBLE', 'RETIRED', NULL, 1),
    ('a0000000-0000-4000-8000-000000000009', 'Tuyết Sơn', 'FEMALE', 'Thoroughbred', 'Grey', 'STAYER', '2011-12-01', '900000000000009', NULL, NULL, NULL, 'b0000000-0000-4000-8000-000000000002', 'UNDER_OBSERVATION', 'RETIRED', NULL, 1),
    ('a0000000-0000-4000-8000-000000000001', 'Sao Mai', 'MALE', 'Thoroughbred', 'Bay', 'SPRINTER', '2019-02-10', '900000000000001', 'a0000000-0000-4000-8000-000000000008', 'a0000000-0000-4000-8000-000000000009', owner_id, 'b0000000-0000-4000-8000-000000000001', 'ELIGIBLE', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000002', 'Gió Bắc', 'GELDING', 'Arabian', 'Grey', 'MILER', '2018-05-21', '900000000000002', 'a0000000-0000-4000-8000-000000000008', NULL, NULL, 'b0000000-0000-4000-8000-000000000001', 'ELIGIBLE', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000003', 'Hỏa Long', 'MALE', 'Thoroughbred', 'Chestnut', 'STAYER', '2017-08-03', '900000000000003', NULL, NULL, NULL, 'b0000000-0000-4000-8000-000000000001', 'ELIGIBLE', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000004', 'Bạch Vân', 'FEMALE', 'Arabian', 'White', 'MILER', '2020-01-15', '900000000000004', NULL, 'a0000000-0000-4000-8000-000000000009', owner_id, 'b0000000-0000-4000-8000-000000000001', 'UNDER_OBSERVATION', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000005', 'Thiên Lý', 'MALE', 'Thoroughbred', 'Black', 'SPRINTER', '2018-11-30', '900000000000005', NULL, NULL, owner_id, 'b0000000-0000-4000-8000-000000000002', 'INJURED', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000006', 'Hắc Phong', 'GELDING', 'Quarter Horse', 'Black', 'STAYER', '2016-07-07', '900000000000006', NULL, NULL, NULL, 'b0000000-0000-4000-8000-000000000003', 'QUARANTINED', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000007', 'Ngọc Lan', 'FEMALE', 'Thoroughbred', 'Bay', 'SPRINTER', '2021-03-18', NULL, NULL, NULL, NULL, NULL, 'ELIGIBLE', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000010', 'Phong Vân', 'MALE', 'Thoroughbred', 'Bay', 'MILER', '2015-06-14', '900000000000010', NULL, NULL, owner_id, NULL, 'ELIGIBLE', 'TRANSFERRED', NULL, 1),
    ('a0000000-0000-4000-8000-000000000011', 'Lam Giang', 'FEMALE', 'Arabian', 'Chestnut', 'SPRINTER', '2019-10-22', '900000000000011', NULL, NULL, owner_id, 'b0000000-0000-4000-8000-000000000002', 'INJURED', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000012', 'Đại Bàng', 'GELDING', 'Thoroughbred', 'Dark Bay', 'MILER', '2018-04-04', '900000000000012', NULL, NULL, NULL, 'b0000000-0000-4000-8000-000000000001', 'ELIGIBLE', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000013', 'Xích Thố', 'MALE', 'Thoroughbred', 'Chestnut', 'STAYER', '2017-01-27', '900000000000013', NULL, NULL, NULL, 'b0000000-0000-4000-8000-000000000001', 'ELIGIBLE', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000014', 'Vô Danh', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'b0000000-0000-4000-8000-000000000001', 'ELIGIBLE', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000015', 'Hồng Hạc', 'FEMALE', 'Arabian', 'Grey', 'MILER', '2020-08-08', '900000000000015', NULL, NULL, NULL, 'b0000000-0000-4000-8000-000000000003', 'QUARANTINED', 'ACTIVE', NULL, 1),
    ('a0000000-0000-4000-8000-000000000016', 'Bóng Đêm (đã xóa)', 'MALE', 'Thoroughbred', 'Black', 'SPRINTER', '2016-02-02', '900000000000016', NULL, NULL, NULL, NULL, 'ELIGIBLE', 'ACTIVE', now() - interval '10 days', 1),
    ('a0000000-0000-4000-8000-000000000017', 'Sương Mù (đã xóa)', 'FEMALE', 'Arabian', 'Grey', 'STAYER', '2013-05-05', NULL, NULL, NULL, NULL, NULL, 'INJURED', 'RETIRED', now() - interval '30 days', 1)
  ON CONFLICT (id) DO NOTHING;

  -- ── Xếp ô chuồng (đang mở: end_at NULL) ─────────────────────
  -- Ngựa không có dòng mở: Ngọc Lan (chưa có khu), Phong Vân (đã chuyển nhượng), Vô Danh (có khu A, chờ xếp ô).
